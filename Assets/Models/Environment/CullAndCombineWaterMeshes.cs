...
public class CullAndCombineWaterMeshes : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Combine by material into submeshes
        ...
        combinedObject.AddComponent<DestroyTracker>().Init(new List<GameObject>(processedObjects));

        Debug.Log($"✅ Combined {processedObjects.Count} objects using {finalMaterials.Count} shared material(s).");
    }
    ...
    class DestroyTracker : MonoBehaviour
    {
        ...
        void OnDestroy()
        {
            ...
            Debug.Log("🧹 Original objects cleaned up after destroying combined mesh.");
        }
    }
}
